-- Migration 22: Convert products.id and all dependent foreign keys (wishlists, cart_items, campaigns) from TEXT to UUID
-- 1. Drop existing FK constraints on all dependent tables
